...
DEFAULT_TOPIC="A README generator that takes a project directory as input and produces a well-structured README.md by analyzing the codebase. It should detect the language, build system, and project structure automatically."
DEFAULT_CONTEXT=""
